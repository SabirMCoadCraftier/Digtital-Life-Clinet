...
const Login = () => {
  ...
  const {
    ...
    setValue,
    formState: { errors },
  } = useForm({ mode: "onBlur" }); // 🔧 FIX: onBlur mode re-syncs values after autofill
          ...
          <form onSubmit={handleSubmit(handleLogin)} className="space-y-3">
            ...
            <div>
              ...
              <input
                ...
                autoComplete="username" // 🔧 FIX: proper autofill sync
            ...
            <div className="relative">
              ...
              <input
                ...
                autoComplete="current-password" // 🔧 FIX: proper autofill sync
                className="w-full px-4 py-2 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
